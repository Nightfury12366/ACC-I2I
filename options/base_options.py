...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./datasets/face2anime',  # required=True,
                            help='/sky_home/skylake/skylake_project/face2anime | ./datasets/afhf | '
                                 './datasets/selfie2anime')
        parser.add_argument('--name', type=str, default='f2a_06',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0, 1, 2, 3',
                            help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='acg_i2i_sc',  # model 的名字
                            help='chooses which model to use. [acg_i2i | acg_i2i_single | acg_i2i_sc]')
        ...
        parser.add_argument('--netD', type=str, default='multi',
                            help='specify discriminator architecture [gray | multi]. The basic model is a '
                                 '70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='SKY_G',
                            help='specify generator architecture [SKY_G | S_V2 | S_V3 | S_V4]')
        ...
        parser.add_argument('--no_antialias_up', action='store_true',
                            help='if specified, use [upconv(learned filter)] '
                                 'instead of [upconv(hard-coded [1,3,3,1] filter), conv]')
        # dataset parameters
        ...
        parser.add_argument('--lock_weight', action='store_true', help='cyc on feature space constrain')
